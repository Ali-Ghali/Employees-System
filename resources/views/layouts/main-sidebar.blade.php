<!-- main-sidebar -->
		...
		<aside class="app-sidebar sidebar-scroll">
			...
			<div class="mb-5 d-flex" style="padding-top:50px;"> <a href="{{ url('/' . $page='Home') }}"><img src="{{URL::asset('assets/img/brand/ghalisoft.png')}}" class="sign-favicon ht-40" alt="logo"></a><h1 class="main-logo1 ml-1 mr-0 my-auto tx-28">Ghali<span>So</span>ft</h1></div>
			</div>
			<div class="main-sidemenu">
				<div class="app-sidebar__user clearfix">
					<div class="dropdown user-pro-body">
						<div class="">
							<img alt="user-img" class="avatar avatar-xl brround" src="{{URL::asset('assets/img/brand/programmer.png')}}"><span class="avatar-status profile-status bg-green"></span>
						</div>
						<div class="user-info">
				...
				<ul class="side-menu">
					<li class="side-item side-item-category">برنامج ذاتية الموظفين</li>
					<li class="slide">
					...
					@can('الموظفين')
					<li class="side-item side-item-category">ذاتية الموظفين</li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
						@can('قائمة الموظفين')
							<li><a class="slide-item" href="{{ url('/' . $page='employees') }}">قائمة الموظفين</a></li>
							@endcan
						</ul>
					</li>
					@endcan
					...
					<li class="slide">
						...
						<ul class="slide-menu">
						@can('تقرير الموظفين')
							<li><a class="slide-item" href="{{ url('/' . $page='employees_report') }}">تقارير الموظفين</a></li>
							@endcan
						</ul>
					</li>
					@endcan
